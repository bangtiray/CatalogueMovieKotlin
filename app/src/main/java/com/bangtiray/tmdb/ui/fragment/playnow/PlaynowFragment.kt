package com.bangtiray.tmdb.ui.fragment.playnow
...
class PlaynowFragment : Fragment(), Contract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    private fun startRefreshing() {
        ...
        presenter.loadData("now", currentPage)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter.subscribe()
        //presenter.loadData("now", currentPage) //slider
        startRefreshing()
